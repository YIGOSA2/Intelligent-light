...
#define FUNC_SENSOR_LIGHT  0x04  //人体感应开灯
#define FUNC_RUN_LIGHT     0x05  //执行主机开灯
#define FUNC_SHUT_LIGHT    0x06  //关灯
#define FUNC_SWTICH_OFF    0x07  //禁用机械开关
#define FUNC_SWITCH_ON     0x08  //使能机械开关
